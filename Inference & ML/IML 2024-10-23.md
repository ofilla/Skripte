...
There is a trade-off between [[20241023134453|bias]] and [[20241023134248|variance]].

#### [[20241023134248|variance]]
...
To validate the optimal hyperparameter, validation data can be selected from the train data, testing the model. One method is the k-fold cross validation.
